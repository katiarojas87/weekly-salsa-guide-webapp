...
# Known coordinates for common BE/NL cities, checked FIRST so a flaky/rate-limited
# Nominatim can't let far cities slip through as "unknown distance".
KNOWN_COORDS = {
    ...
    "alphen aan den rijn": (52.1290, 4.6580), "alkmaar": (52.6324, 4.7534),
}
